! function(a, b) {
    ...
    function bZ(a, c, d, e, f, g) {
        ...
        for (var l, h = a[f], i = 0, j = h ? h.length : 0, k = a === bS; i < j && (k || !l); i++) l = h[i](c, d, e), "string" == typeof l && (!k || g[l] ? l = b : (c.dataTypes.unshift(l), l = bZ(a, c, d, e, l, g)));
    ...
    function bY(a) {
        return function(b, c) {
            if ("string" != typeof b && (c = b, b = "*"), f.isFunction(c))
                for (var h, i, j, d = b.toLowerCase().split(bO), e = 0, g = d.length; e < g; e++) h = d[e], j = /^\+/.test(h), j && (h = h.substr(1) || "*"), i = a[h] = a[h] || [], i[j ? "unshift" : "push"](c)
        }
    }
    ...
    function bB(a, b, c) {
        ...
        if (d > 0) {
            if ("border" !== c)
                for (; e < g; e += 2) c || (d -= parseFloat(f.css(a, "padding" + bx[e])) || 0), "margin" === c ? d += parseFloat(f.css(a, c + bx[e])) || 0 : d -= parseFloat(f.css(a, "border" + bx[e] + "Width")) || 0;
            return d + "px"
        }
        if (d = by(a, b), (d < 0 || null == d) && (d = a.style[b]), bt.test(d)) return d;
        if (d = parseFloat(d) || 0, c)
            for (; e < g; e += 2) d += parseFloat(f.css(a, "padding" + bx[e])) || 0, "padding" !== c && (d += parseFloat(f.css(a, "border" + bx[e] + "Width")) || 0), "margin" === c && (d += parseFloat(f.css(a, c + bx[e])) || 0);
        return d + "px"
    }
    ...
    function l(a, c, d) {
        if (d === b && 1 === a.nodeType) {
            ...
            if (d = a.getAttribute(e), "string" == typeof d) {
                try {
                    d = "true" === d || "false" !== d && ("null" === d ? null : f.isNumeric(d) ? +d : j.test(d) ? f.parseJSON(d) : d)
                } catch (g) {}
                f.data(a, c, d)
            } else d = b
        }
    ...
    function h(a) {
        var c, d, b = g[a] = {};
        for (a = a.split(/\s+/), c = 0, d = a.length; c < d; c++) b[a[c]] = !0;
        return b
    }
    var c = a.document,
        d = a.navigator,
        ...
        f = function() {
            ...
            return e.fn = e.prototype = {
                ...
                each: function(a, c, d) {
                    ...
                    if (d)
                        if (i) {
                            ...
                            for (; g < h && c.apply(a[g++], d) !== !1;);
                    else if (i) {
                        for (f in a)
                            if (c.call(a[f], f, a[f]) === !1) break
                    } else
                        for (; g < h && c.call(a[g], g, a[g++]) !== !1;);
                    return a
                },
                trim: G ? function(a) {
                ...
                map: function(a, c, d) {
                    ...
                    if (k)
                        for (; i < j; i++) f = c(a[i], i, d), null != f && (h[h.length] = f);
                    else
    ...
    f.Callbacks = function(a) {
        ...
        var e, i, j, k, l, m, c = [],
            ...
            n = function(b) {
                var d, e, g, h;
                for (d = 0, e = b.length; d < e; d++) g = b[d], h = f.type(g), "array" === h ? n(g) : "function" === h && (!a.unique || !p.has(g)) && c.push(g)
            },
            o = function(b, f) {
                for (f = f || [], e = !a.memory || [b, f], i = !0, j = !0, m = k || 0, k = 0, l = c.length; c && m < l; m++)
                ...
                remove: function() {
                    if (c)
                        for (var b = arguments, d = 0, e = b.length; d < e; d++)
                            for (var f = 0; f < c.length && (b[d] !== c[f] || (j && f <= l && (l--, f <= m && m--), c.splice(f--, 1), !a.unique)); f++);
                    return this
                },
                has: function(a) {
                    if (c)
        ...
        data: function(a, c) {
            ...
            if (a === b) {
                if (this.length && (m = f.data(j), 1 === j.nodeType && !f._data(j, "parsedAttrs"))) {
                    for (g = j.attributes, i = g.length; k < i; k++) h = g[k].name, 0 === h.indexOf("data-") && (h = f.camelCase(h.substring(5)), l(j, h, m[h]));
    ...
    f.fn.extend({
        ...
        attr: function(a, c, d, e) {
            ...
            if (a && 3 !== j && 8 !== j && 2 !== j) return e && c in f.attrFn ? f(a)[c](d) : "undefined" == typeof a.getAttribute ? f.prop(a, c, d) : (i = 1 !== j || !f.isXMLDoc(a), i && (c = c.toLowerCase(), h = f.attrHooks[c] || (u.test(c) ? x : w)), d !== b ? null === d ? void f.removeAttr(a, c) : h && "set" in h && i && (g = h.set(a, d, c)) !== b ? g : (a.setAttribute(c, "" + d), d) : h && "get" in h && i && null !== (g = h.get(a, c)) ? g : (g = a.getAttribute(c), null === g ? b : g))
        },
        removeAttr: function(a, b) {
            var c, d, e, g, h, i = 0;
            if (b && 1 === a.nodeType)
                for (d = b.toLowerCase().split(p), g = d.length; i < g; i++) e = d[i], e && (c = f.propFix[e] || e, h = u.test(e), h || f.attr(a, e, ""), a.removeAttribute(v ? e : c), h && c in a && (a[c] = !1))
        },
        attrHooks: {
            type: {
                set: function(a, b) {
        ...
        prop: function(a, c, d) {
            ...
            if (a && 3 !== i && 8 !== i && 2 !== i) return h = 1 !== i || !f.isXMLDoc(a), h && (c = f.propFix[c] || c, g = f.propHooks[c]), d !== b ? g && "set" in g && (e = g.set(a, d, c)) !== b ? e : a[c] = d : g && "get" in g && null !== (e = g.get(a, c)) ? e : a[c]
        },
        propHooks: {
            tabIndex: {
                get: function(a) {
    ...
    f.event = {
                ...
                if (g[0] = c, c.delegateTarget = this, !i.preDispatch || i.preDispatch.call(this, c) !== !1) {
                    if (e && (!c.button || "click" !== c.type))
                        for (n = f(this), n.context = this.ownerDocument || this, m = c.target; m != this; m = m.parentNode || this)
                            if (m.disabled !== !0) {
                                for (p = {}, r = [], n[0] = m, k = 0; k < e; k++) s = d[k], t = s.selector, p[t] === b && (p[t] = s.quick ? H(m, s.quick) : n.is(t)), p[t] && r.push(s);
                                r.length && j.push({
                                    elem: m,
                                    matches: r
                                })
            ...
            setup: function() {
                return !f.nodeName(this, "form") && void f.event.add(this, "click._submit keypress._submit", function(a) {
                    var c = a.target,
        ...
        html: function(a) {
            return f.access(this, function(a) {
                ...
                if ("string" == typeof a && !ba.test(a) && (f.support.leadingWhitespace || !X.test(a)) && !bg[(Z.exec(a) || ["", ""])[1].toLowerCase()]) {
                    a = a.replace(Y, "<$1></$2>");
                    try {
                        for (; d < e; d++) c = this[d] || {}, 1 === c.nodeType && (f.cleanData(c.getElementsByTagName("*")), c.innerHTML = a);
                        c = 0
                    } catch (g) {}
                }
    ...
    f.fn.css = function(a, c) {
        ...
        f.cssHooks[b] = {
            get: function(a, c, d) {
                if (c) return 0 !== a.offsetWidth ? bB(a, b, d) : f.swap(a, bw, function() {
                    return bB(a, b, d)
                })
            },
            set: function(a, b) {
    ...
    f.fn.extend({
        show: function(a, b, c) {
            ...
            for (var g = 0, h = this.length; g < h; g++) d = this[g], d.style && (e = d.style.display, !f._data(d, "olddisplay") && "none" === e && (e = d.style.display = ""), ("" === e && "none" === f.css(d, "display") || !f.contains(d.ownerDocument.documentElement, d)) && f._data(d, "olddisplay", cu(d.nodeName)));
            for (g = 0; g < h; g++) d = this[g], d.style && (e = d.style.display, "" !== e && "none" !== e || (d.style.display = f._data(d, "olddisplay") || ""));
            return this
        },
        hide: function(a, b, c) {
            if (a || 0 === a) return this.animate(ct("hide", 3), a, b, c);
            for (var d, e, g = 0, h = this.length; g < h; g++) d = this[g], d.style && (e = f.css(d, "display"), "none" !== e && !f._data(d, "olddisplay") && f._data(d, "olddisplay", e));
